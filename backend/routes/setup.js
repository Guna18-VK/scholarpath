/**
 * One-time setup route — seeds the database remotely
 * Only works in production when SETUP_KEY matches
...
const scholarshipsData = [
  ...
  { name: 'Inspire Scholarship for Higher Education', provider: 'Department of Science & Technology', description: 'For students pursuing Natural and Basic Sciences.', amount: 80000, category: 'merit', eligibilityCriteria: 'Top 1% in Class 12 board exams, pursuing BSc/MSc in Natural Sciences.', minPercentage: 90, maxAnnualIncome: 0, eligibleCommunities: [], eligibleGenders: [], eligibleCourses: ['BSc', 'MSc', 'B.Sc', 'M.Sc'], eligibleStates: [], deadline: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000), applicationLink: 'https://online-inspire.gov.in', requiredDocuments: ['Class 12 Marksheet', 'College Admission Letter', 'Aadhaar Card'], isActive: true, isFeatured: true, tags: ['science', 'merit', 'DST'] },
